    ...
    >
      ...
      <div style={{ maxWidth: "600px", position: "relative", zIndex: 1 }}>
        <div className="fade-in-scroll" style={{ marginBottom: "60px" }}>
          ...
          >
            Dastlabki konsultatsiya bepul, shuning uchun yo'qotadigan hech
            narsangiz yo'q.{" "}
          ...
          >
            ...
            >
              <select
                ...
                style={{
                  color: formData.service ? "var(--cream)" : "#666",
                  borderBottomColor: "rgba(255,255,255,0.2)",
              ...
              >
                ...
                <option value="dev" style={{ color: "var(--dark)" }}>
                  Dasturlash
                </option>
                <option value="whitelabel" style={{ color: "var(--dark)" }}>
                  White-Label
                </option>
                <option value="design-dev" style={{ color: "var(--dark)" }}>
                  Dizayn & Dasturlash
                </option>
                <option value="unsure" style={{ color: "var(--dark)" }}>
                  Aniq emas
                </option>
              </select>
              ...
              <select
                ...
                className="form-field form-select"
                style={{
                  color: formData.budget ? "var(--cream)" : "#666",
                  borderBottomColor: "rgba(255,255,255,0.2)",
                  background: "transparent",
                }}
              >
                ...
                <option value="none" style={{ color: "var(--dark)" }}>
                  Aniq emas
                </option>
                <option value="2-5k" style={{ color: "var(--dark)" }}>
                  $2–5k
                </option>
                <option value="5-8k" style={{ color: "var(--dark)" }}>
                  $5–8k
                </option>
                <option value="8-12k" style={{ color: "var(--dark)" }}>
                  $8–12k
                </option>
                <option value="12k+" style={{ color: "var(--dark)" }}>
                  $12k+
                </option>
              </select>
            </div>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "#e0d8cc")
              }
              onMouseLeave={(e) =>
